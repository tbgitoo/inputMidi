 ...
 *
 * This file is from the native android midi example:
 * https://github.com/android/ndk-samples/blob/main/native-midi/app/src/main/java/com/example/nativemidi/MidiSpec.java
 * It is unmodified (as of April 2025), except this notice and the package name
 *
 * This file remains under the Apache License indicated above, which is however compatible with
 * the general GPLv3.0 license generally applicable for the rest of the project
 */
